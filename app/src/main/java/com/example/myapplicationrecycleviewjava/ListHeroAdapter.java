...
public class ListHeroAdapter extends RecyclerView.Adapter<ListHeroAdapter.ListViewHodler> {
    ...
    @NonNull
    @Override
    public ListViewHodler onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
    ...
    @Override
    public void onBindViewHolder(@NonNull ListHeroAdapter.ListViewHodler holder, int position) {
